    ...
    <section className="bg-white w-full px-5 md:px-16 lg:px-[200px] py-16 md:py-24 lg:py-[150px] flex flex-col gap-16">
      ...
      <div className="flex flex-col gap-8 w-full mt-12">
        ...
        <div className="flex flex-wrap gap-12 items-center">
          <LogoSlot useImg={true} />
          <LogoSlot useImg={false} />
          <LogoSlot useImg={true} />
          <LogoSlot useImg={false} />
          <LogoSlot useImg={true} />
        </div>
...
function ServiceFooter() {
  return (
    <footer id="contact" className="bg-[#1e1e1e] w-full px-5 md:px-10 pt-16 md:pt-24 lg:pt-[150px] pb-10 md:pb-[60px] overflow-hidden">
      <div className="flex flex-col lg:flex-row items-start justify-between gap-16 lg:gap-8">
        ...
        <div className="flex flex-col gap-16 flex-1 min-w-0">
          <div className="flex flex-col gap-4">
            <span className="font-mono text-white font-light text-sm">PRODUCT & EXPERIENCE DESIGN</span>
            <h2 className="font-sans font-regular leading-[1.1] text-white text-[38px] sm:text-[52px] md:text-[60px] lg:text-[64px] tracking-[-1.92px] max-w-[680px]">
              Have a product that needs more clarity?
            </h2>
            <p className="font-sans font-regular text-[#b4b4b4] text-base md:text-lg max-w-[550px] leading-[1.5] mt-2">
              Tell us where the experience is getting complicated and what your team needs to move forward.
            </p>
          </div>
          <div className="flex flex-wrap gap-8 items-center">
            ...
            <span className="font-mono font-regular text-white text-base cursor-pointer hover:opacity-70 transition-opacity">BOOK A DISCOVERY CALL</span>
          </div>
          <div className="flex flex-col gap-3">
