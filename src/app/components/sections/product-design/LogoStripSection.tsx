...
export function LogoStripSection({ title = "Selected experience & collaborations" }: LogoStripSectionProps) {
  const clientLogos = [
    "client-junso",
    "client-metalindo",
    "client-nyambee",
  ...
  return (
    <section className="bg-[#ffffff] w-full py-[75px] md:pb-24 flex flex-col gap-6 md:gap-8 items-center" data-name="Product Design Clients Section">
      {/* Title */}
